...
=end
    ...
    @stemcell_storage_prof  = ENV['BOSH_VCLOUD_CPI_STEMCELL_STORAGE_PROFILE']     || raise("Missing BOSH_VCLOUD_CPI_STEMCELL_STORAGE_PROFILE")
    ...
    @cpi = described_class.new(
      ...
      'vcds' => [{
        ...
        'entities' => {
          ...
          'stemcell_storage_profile' => @stemcell_storage_prof,
